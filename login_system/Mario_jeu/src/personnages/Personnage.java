...
public class Personnage {
	//**** VARIABLES ****//
		...
		public int compteurMort; //utilise lorsque le personnage meurt
	    ...
	    public Image marche(String nom, int frequence){ //nom du personnage et frequence des pas		
	    	String str;	
			ImageIcon ico;
			Image img;
	    ...
	    // contact de mario avec les personnages
